...
/* [LOG-CLEANER-START] console.log('console.log 1000000'); [LOG-CLEANER-END] */
...
writable.end();
/* [LOG-CLEANER-START] console.log(5, '文件写入完成'); [LOG-CLEANER-END] */

// 读取文件
const readable = fs.createReadStream(outputFile);
readable.on('data', (chunk) => {
    /* [LOG-CLEANER-START] console.log(chunk.toString()); [LOG-CLEANER-END] */
});
readable.on('end', () => {
    /* [LOG-CLEANER-START] console.log(6, '文件读取完成'); [LOG-CLEANER-END] */
});
...
fs.unlink(outputFile, (err) => {
    if (err) {
        ...
        /* [LOG-CLEANER-START] console.log(9, '文件删除完成'); [LOG-CLEANER-END] */
    }
});